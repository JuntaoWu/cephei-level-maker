...
Renderer.toolStateMap = {
    ...
    'circle [a]': Renderer.DRAWCIRCLE,  // circle, hole, cueBall, ball
    'rectangle [f]': Renderer.DRAWRECTANGLE  // rectangle, hole, wall, attackWall
};
...
Renderer.prototype.handleMouseUp = function(physicsPosition){
    ...
    case Renderer.DRAWINGCIRCLE:
        ...
        if(R > 0){
            // Create circle
            b = new p2.Body({ mass : 0, position : this.drawCircleCenter, fixedRotation: true, });
